...
namespace cepgen {
  ...
  class APFELCollinearFlux final : public CollinearFlux {
  public:
    /// Build a calculator from its Parameters object
    explicit APFELCollinearFlux(const ParametersList& params)
        : CollinearFlux(params), pdgid_(steer<pdgid_t>("partonPdgId")), q_range_(steer<Limits>("qrange")) {
      ...
      CG_INFO("APFELCollinearFlux") << "Partonic collinear parton flux evaluator successfully built.\n"
