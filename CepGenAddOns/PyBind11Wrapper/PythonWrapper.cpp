...
#define EXPOSE_FACTORY(obj, key, name, description)                                                               \
  py::class_<obj, boost::noncopyable>(m, name, description)                                                       \
      .def_static("__new__", [](py::object) { return obj::get(); })                                               \
      ...
      .add_static_property(                                                                                       \
          "modules", +[]() { return obj::get().modules(); })

namespace {
  PYBIND11_MODULE(pycepgen, m) {
    cepgen::initialise();

    py::class_<cepgen::Steerable>(m, "_Steerable", "base steerable object", py::no_init)
        .add_property(
            "parameters",
    ...
    py::class_<cepgen::strfun::Parameterisation, py::bases<cepgen::Steerable>, boost::noncopyable>(
        m, "_StructureFunctions", "nucleon structure functions modelling", py::no_init)
    ...
    py::class_<cepgen::sigrat::Parameterisation, py::bases<cepgen::Steerable>, boost::noncopyable>(
        m, "_SigmaRatio", "L/T cross section ratio modelling", py::no_init)
        .def(
    ...
    py::class_<cepgen::formfac::Parameterisation, py::bases<cepgen::Steerable>, boost::noncopyable>(
        m, "_FormFactors", "nucleon electromagnetic form factors modelling", py::no_init)
        .def("__call__",
             py::make_function(&cepgen::formfac::Parameterisation::operator(), py::return_internal_reference()));

    py::class_<cepgen::formfac::FormFactors>(m, "FormFactors", "nucleon electromagnetic form factors values")
