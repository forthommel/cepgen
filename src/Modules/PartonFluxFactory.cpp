...
ParametersDescription PartonFluxFactory::describeParameters(const std::string& name, const ParametersList& params) {
  if (name.empty())
...
bool PartonFluxFactory::elastic(const ParametersList& params) {
