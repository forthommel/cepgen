...
namespace cepgen {
  ...
  public:
    ...
    static ParametersDescription description() {
      ...
      desc.add<ParametersDescription>("integrator", ParametersDescription().setName("gsl"))
          .setDescription("numerical integrator algorithm to use");
      desc.add<ParametersDescription>("unintegratedFlux", ParametersDescription().setName("EPAFlux"))
    ...
    spdgid_t partonPdgId() const override { return unint_flux_->partonPdgId(); }
